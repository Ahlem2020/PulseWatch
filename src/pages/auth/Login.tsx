...
import { Eye, EyeOff, Radar, Github, Mail } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background flex">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all pr-10"
      ...
      <motion.div
        ...
        className="hidden lg:flex flex-1 bg-gradient-to-br from-accent to-accent-secondary p-12 items-center justify-center relative overflow-hidden"
      >
        ...
        <div className="relative text-white max-w-lg">
          ...
          >
            ...
            <p className="text-lg text-white/80 mb-8">
              Track mentions, analyze sentiment, and engage with your audience across all social platforms from one powerful dashboard.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div>
                ...
                <div className="text-white/70 text-sm">Mentions Tracked</div>
              </div>
              <div>
        ...
        <motion.div
          ...
          className="absolute bottom-32 left-20 w-16 h-16 bg-white/10 rounded-full backdrop-blur-sm"
        />
      </motion.div>
    </div>
  );
